...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'TPL'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '400743056c3e0a656c5ae3aa5bbeb4c9'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_orders,write_orders,read_assigned_fulfillment_orders,write_assigned_fulfillment_orders,read_customers,write_customers,read_all_orders,read_shipping,write_shipping,read_fulfillments,write_fulfillments,read_third_party_fulfillment_orders,write_third_party_fulfillment_orders,read_third_party_fulfillment_orders,write_third_party_fulfillment_orders,read_merchant_managed_fulfillment_orders'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://rider-pakistan.com/webhook/app-uninstalled')
        ],
        /*
            [
